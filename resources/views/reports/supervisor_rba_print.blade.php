...
<head>
    ...
    <title>Laporan Rincian Belanja Usulan RBA Supervisor - {{ $submission->unit->name ?? 'Unit' }} ({{ $submission->header->year ?? '' }})</title>
    <style>
        /* ==========================================================================
           SIPAKAR SUPERVISOR RBA REPORT PRINT TEMPLATE
           ========================================================================== */
...
<body>
    ...
    <div class="no-print-bar">
        <div>
            <h3>🖨️ Pratinjau Cetak Supervisor - Rincian Belanja RBA</h3>
        </div>
        <div style="display: flex; gap: 10px;">
            <a href="{{ route('supervisor.submissions.show', $submission->id) }}" class="btn-action btn-back">
                ← Kembali ke Workboard Supervisor
            </a>
    ...
    <div class="page-container">
        ...
        <table class="meta-table">
            ...
            <tr>
                <td class="meta-label">SUPERVISOR REVIU</td>
            ...
            <tr>
                ...
                <td class="meta-value">: <strong>{{ $operatorFilterLabel }}</strong></td>
            ...
            <tr>
                ...
                <td class="meta-label">TOTAL RINCIAN</td>
                <td class="meta-value">: {{ $submission->details->count() }} Item Belanja</td>
            </tr>
        </table>
        ...
        <table class="data-table">
                ...
                @empty
                    <tr>
                        <td colspan="10" class="text-center" style="padding: 20px; color: #64748b; font-style: italic;">
                            Belum ada rincian belanja usulan yang sesuai dengan filter operator yang dipilih.
                        </td>
                    </tr>
                @endforelse
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="4" class="text-right">TOTAL AKUMULASI USULAN:</td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="sig-title">
                            ...
                            <strong>Penyusun RBA Sub-Unit</strong>
                        </div>
                        <div class="sig-name">( ___________________________ )</div>
                        <div class="sig-role">Tim Operator / Penyusun RBA</div>
                    </td>
                </tr>
            </table>
        </div>
