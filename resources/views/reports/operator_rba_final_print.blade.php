...
<head>
    ...
    <title>Laporan RBA Final dengan Pagu - {{ $submission->unit->name ?? 'Unit' }} ({{ $submission->header->year ?? '' }})</title>
    <style>
        /* ==========================================================================
           SIPAKAR RBA FINAL REPORT PRINT TEMPLATE SYSTEM
           ========================================================================== */
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="section-header" style="display: flex; justify-content: space-between; align-items: baseline;">
            <span>{{ $sectionIndex++ }}. RINCIAN BELANJA DAN PAGU FINAL {{ ($grouping ?? 'account') === 'flat' ? '(FORMAT PER BARIS USULAN / FLAT)' : '(FORMAT TERKELOMPOK REKENING)' }}</span>
            @if(isset($sortLabel))
        ...
        <table class="data-table">
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-right font-mono font-bold" style="color: #047857;">
                        {{ $totalPaguFinal > 0 ? 'Rp ' . number_format($totalPaguFinal, 0, ',', '.') : '-' }}
                    </td>
                    <td></td>
                </tr>
            </tfoot>
