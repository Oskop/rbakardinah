                    ...
                    <form action="{{ route('operator.details.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <input type="number" name="volume" id="volume" step="0.01" min="0.01" value="1.00"
                            ...
                            <div>
                                ...
                                <input type="text" name="satuan" id="satuan" placeholder="Contoh: Rim, Pcs, Bln"
                                    class="w-full border-gray-300 rounded-md shadow-sm" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="harga_satuan" id="harga_satuan" min="0" value="0"
                                    class="w-full border-gray-300 rounded-md shadow-sm" required>
