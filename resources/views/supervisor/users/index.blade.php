    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Manajemen User - ') }} {{ Auth::user()->unit?->name }}
            </h2>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-5">
                <div class="flex items-center justify-between pb-3 mb-4 border-b border-slate-100">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            <h3 class="text-xs font-extrabold uppercase tracking-wider text-slate-800">Filter Kolom Pengguna Unit</h3>
                            <p class="text-[11px] text-slate-400">Saring pengguna di unit kerja Anda berdasarkan kriteria di bawah ini</p>
                        </div>
                    </div>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                const table = $('#supervisor-users-table').DataTable({
                    responsive: true,
                    language: {
                        search: "Cari Bebas:",
