<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <h2 class="font-extrabold text-2xl text-gray-800 leading-tight flex items-center gap-2">
                <span>{{ __('Supervisor Dashboard - SIPAKAR RBA') }}</span>
            </h2>
            <div class="flex items-center gap-2">
                <a href="{{ route('supervisor.submissions.index') }}"
                    ...
                    <span>Review Usulan RBA</span>
                </a>
                <a href="{{ route('supervisor.users.index') }}"
                    class="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2 px-4 rounded-xl shadow transition-all duration-150 text-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="py-8 bg-gray-50/50 min-h-[calc(100vh-4rem)]" x-data="{
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div
                class="bg-gradient-to-r from-emerald-700 via-teal-600 to-indigo-700 rounded-2xl shadow-lg p-6 text-gray-700 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <h3 class="text-xl font-extrabold tracking-tight text-white">Selamat Datang Supervisor,
                        {{ Auth::user()->name }} 👋
                    </h3>
                    <p class="text-emerald-100 text-sm mt-1 max-w-2xl leading-relaxed">
                        Pantau rekapitulasi usulan RBA dari seluruh operator. Pilih dokumen RBA untuk meninjau rincian
                        total
