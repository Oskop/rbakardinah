<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3" x-data="{ openPrintModal: false, printType: 'usulan', grouping: 'account', filterScope: 'all', selectedUnits: [], selectedOperators: [], sortBy: 'account_code', sortDir: 'asc' }">
                <!-- Tombol Cetak Admin -->
                        ...
                        <div x-show="openPrintModal" x-transition:enter="ease-out duration-300"
                            ...
                            <form :action="printType === 'final' ? '{{ route('admin.headers.print-preview-final', $header->id) }}' : '{{ route('admin.headers.print-preview', $header->id) }}'" method="GET" target="_blank" @submit="openPrintModal = false">
                                ...
                                <div class="p-6 space-y-5">
                                    ...
                                    <!-- 4. Opsi Filter Scope -->
                                    <div>
                                        <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">4. Filter Scope Cetak</label>
