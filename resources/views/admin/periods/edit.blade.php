                    ...
                    <form
                        ...
                        <div class="mb-4">
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $period->is_active ?? true) ? 'checked' : '' }}
                                    class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <span class="ml-2 text-sm font-medium text-gray-700">Status Aktif (Active)</span>
                            </label>
                            <p class="text-xs text-gray-500 mt-1">Hilangkan centang jika ingin menonaktifkan periode ini.</p>
                        </div>
