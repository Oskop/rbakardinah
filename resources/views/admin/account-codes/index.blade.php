                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($accountCodes as $code)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $code->name }}</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <form action="{{ route('admin.account-codes.destroy', $code) }}" method="POST"
                                                class="inline-block"
                                                onsubmit="return confirm('Are you sure you want to delete this account code?');">
                                                @csrf
                                                @method('DELETE')
